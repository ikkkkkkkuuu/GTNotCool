...
public class GeneralChemicalFactoryRecipes {
    ...
    public static void loadRecipes() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(FluidRegistry.getFluidStack("molten.silicone", 1296))
            .specialValue(400)
            .eut(96)
            .duration(128)
            .addTo(GCFR);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(FluidRegistry.getFluidStack("molten.silicone", 1296 * 64))
            .specialValue(800)
            .eut(96)
            .duration(128 * 64)
            .addTo(GCFR);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(FluidRegistry.getFluidStack("polyurethaneresin", 1000 * 45))
            .specialValue(11700)
            .eut(RECIPE_UIV)
            .duration(20 * 64)
            .addTo(GCFR);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(15), Materials.Carbon.getDust(41))
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Hydrogen.getGas(1000 * 5), Materials.Oxygen.getGas(1000))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                GTUtility.copyAmountUnsafe(0, GTModHandler.getModItem("dreamcraft", "RadoxPolymerLens", 1)),
                WerkstoffLoader.PTMetallicPowder.get(OrePrefixes.dust, 28))
            .fluidInputs(Materials.Chlorine.getGas(3760), Materials.Oxygen.getGas(1000 * 45))
            .itemOutputs(
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(Materials.Palladium.getDust(10))
            .specialValue(9900)
            .eut(RECIPE_HV)
            .duration(20 * 10)
            .addTo(GCFR);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Oxygen.getGas(1000 * 83), Materials.SaltWater.getFluid(1000 * 57))
            .itemOutputs(
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidOutputs(Materials.Hydrogen.getGas(1000 * 71))
            .specialValue(9900)
            .eut(RECIPE_IV)
            .duration(20 * 57)
            .addTo(GCFR);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Hydrogen.getGas(1000 * 72))
            .itemOutputs(WerkstoffLoader.Ruthenium.get(OrePrefixes.dust, 12), Materials.Sodium.getDust(5))
            .fluidOutputs(Materials.Chlorine.getGas(2500))
            .specialValue(9900)
            .eut(RECIPE_LuV)
            .duration(20 * 12)
            .addTo(GCFR);
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Hydrogen.getGas(1000 * 51), Materials.Chlorine.getGas(1000 * 24))
            .itemOutputs(
        ...
        GTValues.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Hydrogen.getGas(1000 * 40), Materials.Chlorine.getGas(1000 * 20))
            .itemOutputs(
                Materials.Iridium.getDust(10),
                Materials.Nickel.getDust(5),
                Materials.Copper.getDust(5),
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.copyAmountUnsafe(0, GTModHandler.getModItem("dreamcraft", "RadoxPolymerLens", 1)))
            .fluidInputs(WerkstoffLoader.AcidicOsmiumSolution.getFluidOrGas(10000), Materials.Hydrogen.getGas(1000 * 6))
            .itemOutputs(Materials.Osmium.getDust(1))
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(GGMaterial.naquadahEarth.get(OrePrefixes.dust, 60), Materials.Trinium.getDust(10))
            .fluidOutputs(
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                GTUtility.copyAmountUnsafe(102, Materials.Sulfur.getDust(1)))
            .fluidOutputs(Materials.Naquadria.getMolten(144 * 100), Materials.Oxygen.getGas(1000 * 276))
            .specialValue(11700)
            .eut(RECIPE_ZPM)
            .duration(20 * 100)
            .addTo(GCFR);
