...
public final class FuelRefiningComplexRecipes {

    private static final FuelRefiningMetadata FUEL_REFINING_TIER = FuelRefiningMetadata.INSTANCE;
    private static final RecipeMap<?> FCR = GTNCRecipeMaps.FuelRefiningComplexRecipes;

    private FuelRefiningComplexRecipes() {}
