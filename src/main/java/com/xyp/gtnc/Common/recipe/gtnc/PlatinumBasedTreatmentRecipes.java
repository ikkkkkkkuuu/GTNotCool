...
public final class PlatinumBasedTreatmentRecipes {

    private static final RecipeMap<?> PBTR = GTNCRecipeMaps.PlatinumBasedTreatmentRecipes;

    private PlatinumBasedTreatmentRecipes() {}
