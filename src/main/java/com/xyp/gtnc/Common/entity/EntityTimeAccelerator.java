...
/**
 * 时间加速器实体，用于加速方块和TileEntity的更新
 */
public class EntityTimeAccelerator extends Entity {

    // region Fields
    private int timeRate = enableTimeAcceleratorBoost ? Config.timeVialInitialRate * 2 : Config.timeVialInitialRate; // must
                                                                                                                     // be
                                                                                                                     // set
                                                                                                                     // in
                                                                                                                     // here
                                                                                                                     ...
                                                                                                                     // render
                                                                                                                     // init
    public static final int ACCELERATION_TICK = Config.timeVialBaseDuration;
    ...
    public void setTimeRate(int timeRate) {
        ...
        // 强制标记dataWatcher为已修改，确保同步到客户端
        if (!this.worldObj.isRemote) {
            this.dataWatcher.setObjectWatched(2);
        }
    }
    ...
    /**
     * 强制同步dataWatcher到所有追踪此实体的玩家
     * Force sync dataWatcher to all players tracking this entity
     */
    @Override
    public void onUpdate() {
        super.onUpdate();
        // 在服务端，每10tick强制同步一次dataWatcher
