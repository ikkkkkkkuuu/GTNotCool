    ...
    private static ButtonWidget<?> createUpgradeButton(PanelSyncManager syncManager, ForgeOfGodsUpgrade upgrade) {
        ...
        return new ButtonWidget<>().size(NODE_WIDTH, NODE_HEIGHT)
            ...
            .tooltipDynamic(tooltip -> {
                ...
                if (upgrade == ForgeOfGodsUpgrade.SEFCP) {
                    tooltip
                        .addLine(EnumChatFormatting.GREEN + TextLocalization.GUI_STEAM_ELEVATOR_EVOLUTION_SEFCP_EFFECT);
                }
                ...
                if (upgrade == ForgeOfGodsUpgrade.GEM) {
                    tooltip
                        .addLine(EnumChatFormatting.GREEN + TextLocalization.GUI_STEAM_ELEVATOR_EVOLUTION_GEM_EFFECT);
                }
                if (upgrade == ForgeOfGodsUpgrade.CTCDD) {
                    tooltip
                        .addLine(EnumChatFormatting.GREEN + TextLocalization.GUI_STEAM_ELEVATOR_EVOLUTION_CTCDD_EFFECT);
                }
                if (upgrade == ForgeOfGodsUpgrade.GGEBE) {
                    tooltip
                        .addLine(EnumChatFormatting.GREEN + TextLocalization.GUI_STEAM_ELEVATOR_EVOLUTION_GGEBE_EFFECT);
                }
