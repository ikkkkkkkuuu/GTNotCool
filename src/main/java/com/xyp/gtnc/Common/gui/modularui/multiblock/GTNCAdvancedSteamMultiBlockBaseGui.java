...
public class GTNCAdvancedSteamMultiBlockBaseGui
    extends GTNCUpgradeableMultiBlockBaseGui<GTNCAdvancedSteamMultiBlockBase<?>> {

    public GTNCAdvancedSteamMultiBlockBaseGui(GTNCAdvancedSteamMultiBlockBase<?> multiblock) {
        super(multiblock);
    }
