...
// #tr LargeSteamCircuitAssemblerRecipeType
// # Circuit Assembler
// # zh_CN 电路组装机

// #tr Tooltip_LargeSteamCircuitAssembler_00
// # A large steam-powered circuit assembler
// # zh_CN 大型蒸汽电路组装机

// #tr Tooltip_LargeSteamCircuitAssembler_01
// # Bronze machine recipe tier: MV, Steel machine recipe tier: HV
// # zh_CN 青铜机器配方等级:MV 钢机器配方等级:HV

// #tr Tooltip_LargeSteamCircuitAssembler_02
// # Insert Stainless Steel gear into controller for recipe tier +1
// # zh_CN 在主机里插入不锈钢齿轮配方等级+1

// #tr Tooltip_LargeSteamCircuitAssembler_Casing
// # Machine casing
// # zh_CN 机器外壳

public class LargeSteamCircuitAssembler extends MTESteamMultiBlockBase<LargeSteamCircuitAssembler>
        ...
        if (STRUCTURE_DEFINITION == null) {
            STRUCTURE_DEFINITION = StructureDefinition.<LargeSteamCircuitAssembler>builder()
                ...
                .addElement(
                    'D',
                    ofBlocksTiered(
                        LargeSteamCircuitAssembler::getTierFrame,
                        ImmutableList.of(
        ...
        return new ProcessingLogic() {
            ...
            protected OverclockCalculator createOverclockCalculator(@Nonnull GTRecipe recipe) {
                ...
                return OverclockCalculator.ofNoOverclock(recipe)
                    .setEUtDiscount(1.25 * effectiveTier)
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("LargeSteamCircuitAssemblerRecipeType"))
            ...
            .addSteamInputBus(StatCollector.translateToLocal("Tooltip_LargeSteamCircuitAssembler_Casing"), 1)
            .addSteamOutputBus(StatCollector.translateToLocal("Tooltip_LargeSteamCircuitAssembler_Casing"), 1)
