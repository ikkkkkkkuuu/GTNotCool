...
public class SteamGodforgeAlloyBlastSmelterModule extends MTESmeltingModule
    ...
    public SteamGodforgeAlloyBlastSmelterModule(int id, String name, String regionalName) {
        super(id, name, regionalName);
    }

    public SteamGodforgeAlloyBlastSmelterModule(String name) {
        super(name);
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity tileEntity) {
        return new SteamGodforgeAlloyBlastSmelterModule(mName);
    }
    ...
    public MultiblockTooltipBuilder createTooltip() {
        return SteamGodforgeTooltips.module(
            TextLocalization.SteamGodforgeAlloyBlastSmelterModuleMachineType,
            TextLocalization.Tooltip_SteamGodforgeAlloyBlastSmelterModule_00,
            TextLocalization.Tooltip_SteamGodforgeAlloyBlastSmelterModule_01,
            TextLocalization.Tooltip_SteamGodforgeAlloyBlastSmelterModule_02,
            TextLocalization.Tooltip_SteamGodforgeAlloyBlastSmelterModule_03,
            TextLocalization.Tooltip_SteamGodforgeAlloyBlastSmelterModule_04,
            TextLocalization.Tooltip_SteamGodforge_perfect,
            TextLocalization.Tooltip_SteamGodforgeAlloyBlastSmelterModule_06);
