...
import static com.xyp.gtnc.utils.lang.TextLocalization.ADVANCED_SUPER_BUS_00;
import static com.xyp.gtnc.utils.lang.TextLocalization.ADVANCED_SUPER_BUS_01;
import static com.xyp.gtnc.utils.lang.TextLocalization.ADVANCED_SUPER_BUS_02;
import static com.xyp.gtnc.utils.lang.TextLocalization.ADVANCED_SUPER_BUS_03;
import static com.xyp.gtnc.utils.lang.TextLocalization.SUPER_AMOUNT;
import static com.xyp.gtnc.utils.lang.TextLocalization.SUPER_BUS_00;
import static com.xyp.gtnc.utils.lang.TextLocalization.SUPER_BUS_01;
import static com.xyp.gtnc.utils.lang.TextLocalization.SUPER_BUS_02;
import static com.xyp.gtnc.utils.lang.TextLocalization.SUPER_BUS_03;
import static com.xyp.gtnc.utils.lang.TextLocalization.SUPER_BUS_04;
import static com.xyp.gtnc.utils.lang.TextLocalization.SUPER_BUS_05;
...
import com.xyp.gtnc.Common.gui.modularui.hatch.SuperInputBusMEGui;
...
public class SuperInputBusME extends MTEHatchInputBusME implements IConfigurationCircuitSupport,
    ...
    /**
     * The current GT version owns a final two-slot inventory in the parent ME bus.
     * Keep the 281-slot super-bus inventory separate instead of attempting to
     * replace that final field through a mixin accessor.
     */
    public final ItemStack[] mInventory = new ItemStack[ALL_SLOT_COUNT];
    public final ItemStackHandler inventoryHandler = new ItemStackHandler(mInventory) {
    ...
    public String[] getDescription() {
        ...
        strings.add(SUPER_BUS_00);
        strings.add(
            SUPER_BUS_01 + GTValues.TIER_COLORS[autoPullAvailable ? 7 : 4] + GTValues.VN[autoPullAvailable ? 7 : 4]);
        strings.add(SUPER_BUS_02);
        strings.add(SUPER_BUS_03);

        if (autoPullAvailable) {
            strings.add(ADVANCED_SUPER_BUS_00);
            strings.add(ADVANCED_SUPER_BUS_01);
            strings.add(ADVANCED_SUPER_BUS_02);
            strings.add(ADVANCED_SUPER_BUS_03);
        }

        strings.add(SUPER_BUS_04);
        strings.add(SUPER_BUS_05);
    ...
    public void saveNBTData(NBTTagCompound aNBT) {
        ...
        NBTTagList persistentInventory = new NBTTagList();
        for (int i = 0; i < mInventory.length; i++) {
            if (i >= SIDE_SLOT_COUNT && i < SIDE_SLOT_COUNT * 2 || mInventory[i] == null) {
                continue;
            }
            NBTTagCompound stackTag = GTUtility.saveItem(mInventory[i]);
            stackTag.setInteger("slot", i);
            persistentInventory.appendTag(stackTag);
        }
        aNBT.setTag("superInventory", persistentInventory);
    ...
    public void loadNBTData(NBTTagCompound aNBT) {
        ...
        NBTTagList persistentInventory = aNBT.getTagList("superInventory", 10);
        for (int i = 0; i < persistentInventory.tagCount(); i++) {
        ...
        if (gridProxy == null) {
            if (getBaseMetaTileEntity() instanceof IGridProxyable) {
                gridProxy = new AENetworkProxy(
                    ...
                    "proxy",
                    autoPullAvailable ? GTNCItemList.AdvancedSuperInputBusME.get(1)
    ...
    public void addUIWidgets(ModularWindow.Builder builder, UIBuildContext buildContext) {
        ...
        builder.widget(TextWidget.dynamicText(() -> {
            ...
            if (isActive && isPowered) {
                return new Text(MessageFormat.format("{0}{1}搂f", EnumChatFormatting.GREEN, state));
            } else {
