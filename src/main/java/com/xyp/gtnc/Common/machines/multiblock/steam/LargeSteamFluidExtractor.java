...
public class LargeSteamFluidExtractor extends GTNCAdvancedSteamMultiBlockBase<LargeSteamFluidExtractor>
    ...
    private static final String[][] shape = new String[][] { { "BBBBB", "BBBBB", "BBBBB" },
        { "BB~BB", "BC CB", "BBBBB" }, { "BBBBB", "BBBBB", "BBBBB" } };
