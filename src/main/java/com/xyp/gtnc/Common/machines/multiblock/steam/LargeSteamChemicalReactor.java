...
// #tr LargeSteamChemicalReactorRecipeType
// # Chemical Reactor
// # zh_CN 化学反应釜

// #tr Tooltip_LargeSteamChemicalReactor_00
// # A large steam-powered chemical reactor
// # zh_CN 大型蒸汽化学反应釜

// #tr Tooltip_LargeSteamChemicalReactor_01
// # Bronze machine recipe tier: MV, Steel machine recipe tier: HV
// # zh_CN 青铜机器配方等级:MV 钢机器配方等级:HV

// #tr Tooltip_LargeSteamChemicalReactor_02
// # Insert Stainless Steel gear into controller for recipe tier +1
// # zh_CN 在主机里插入不锈钢齿轮配方等级+1

// #tr Tooltip_LargeSteamChemicalReactor_Casing
// # Machine casing
// # zh_CN 机器外壳

public class LargeSteamChemicalReactor extends GTNCSteamMultiBlockBase<LargeSteamChemicalReactor>
    implements ISurvivalConstructable {

    public LargeSteamChemicalReactor(String aName) {
        super(aName);
    }

    public LargeSteamChemicalReactor(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new LargeSteamChemicalReactor(this.mName);
    }

    @Override
    public String getMachineType() {
        return StatCollector.translateToLocal("LargeSteamChemicalReactorRecipeType");
    }
    ...
    private IStructureDefinition<LargeSteamChemicalReactor> STRUCTURE_DEFINITION = null;
    ...
    @Override
    public IStructureDefinition<LargeSteamChemicalReactor> getStructureDefinition() {
        if (STRUCTURE_DEFINITION == null) {
            STRUCTURE_DEFINITION = StructureDefinition.<LargeSteamChemicalReactor>builder()
                .addShape(STRUCTURE_PIECE_MAIN, transpose(shape))
                .addElement('A', chainAllGlasses())
                .addElement(
                    'B',
                    ofChain(
                        buildSteamInput(LargeSteamChemicalReactor.class).casingIndex(10)
                            .hint(1)
                            .build(),
                        buildHatchAdder(LargeSteamChemicalReactor.class)
                            .atLeast(
                ...
                .addElement(
                    'C',
                    ofBlocksTiered(
                        LargeSteamChemicalReactor::getTierPipeCasing,
                ...
                .addElement(
                    'D',
                    ofBlocksTiered(
                        LargeSteamChemicalReactor::getTierFrame,
                        ImmutableList.of(
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("LargeSteamChemicalReactorRecipeType"))
            .addInfo(StatCollector.translateToLocal("Tooltip_LargeSteamChemicalReactor_00"))
            .addInfo(StatCollector.translateToLocal("Tooltip_LargeSteamChemicalReactor_01"))
            .addInfo(StatCollector.translateToLocal("Tooltip_LargeSteamChemicalReactor_02"))
            .addSteamBulkMachineInfo(256, 2f, 0.45f)
            .addInfo(HIGH_PRESSURE_TOOLTIP_NOTICE)
            .beginStructureBlock(5, 5, 9, false)
            .addController("Front center")
            .addSteamInputBus(StatCollector.translateToLocal("Tooltip_LargeSteamChemicalReactor_Casing"), 1)
            .addSteamOutputBus(StatCollector.translateToLocal("Tooltip_LargeSteamChemicalReactor_Casing"), 1)
            .addInputBus(StatCollector.translateToLocal("Tooltip_LargeSteamChemicalReactor_Casing"), 1)
            .addOutputBus(StatCollector.translateToLocal("Tooltip_LargeSteamChemicalReactor_Casing"), 1)
            .addInputHatch(StatCollector.translateToLocal("Tooltip_LargeSteamChemicalReactor_Casing"), 1)
            .addOutputHatch(StatCollector.translateToLocal("Tooltip_LargeSteamChemicalReactor_Casing"), 1)
