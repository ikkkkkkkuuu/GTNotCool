 ...
 */
public abstract class GTNCAdvancedSteamMultiBlockBase<T extends GTNCAdvancedSteamMultiBlockBase<T>>
    extends GTNCSteamMultiBlockBase<T> {
    ...
    public GTNCAdvancedSteamMultiBlockBase(String aName) {
        super(aName);
    }

    public GTNCAdvancedSteamMultiBlockBase(int aID, String aName, String aNameRegional) {
