...
public class GTNCDrillingRig extends GTNCWirelessEnergyMultiMachineBase<GTNCDrillingRig>
    ...
    private static IStructureDefinition<GTNCDrillingRig> STRUCTURE_DEFINITION = null;
    ...
    // ==================== Constructors ====================
    public GTNCDrillingRig(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public GTNCDrillingRig(String aName) {
        super(aName);
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GTNCDrillingRig(this.mName);
    }
    ...
    @Override
    public IStructureDefinition<GTNCDrillingRig> getStructureDefinition() {
        if (STRUCTURE_DEFINITION == null) {
            STRUCTURE_DEFINITION = StructureDefinition.<GTNCDrillingRig>builder()
                .addShape(STRUCTURE_PIECE_MAIN, SHAPE)
                .addElement(
                    'A',
                    buildHatchAdder(GTNCDrillingRig.class)
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        // #tr GTNCDrillingRigRecipeType
        // # Drilling Rig
        // # zh_CN 钻井平台
        tt.addMachineType(StatCollector.translateToLocal("GTNCDrillingRigRecipeType"))
            // #tr Tooltip_GTNCDrillingRig_01
            ...
            .addInfo(StatCollector.translateToLocal("Tooltip_GTNCDrillingRig_03"))
