...
public class EnergyMonitorFormatter {
    ...
    public static String formatDuration(BigInteger ticks) {
        if (ticks == null || ticks.signum() <= 0) {
            return "0" + StatCollector.translateToLocal("gtnc.energy_monitor.time.second");
        }
        ...
        appendTimeUnit(builder, years, "gtnc.energy_monitor.time.year");
        appendTimeUnit(builder, months, "gtnc.energy_monitor.time.month");
        appendTimeUnit(builder, days, "gtnc.energy_monitor.time.day");
        appendTimeUnit(builder, hours, "gtnc.energy_monitor.time.hour");
        appendTimeUnit(builder, minutes, "gtnc.energy_monitor.time.minute");
        appendTimeUnit(builder, seconds, "gtnc.energy_monitor.time.second");
        return builder.length() == 0 ? "0" + StatCollector.translateToLocal("gtnc.energy_monitor.time.second")
            : builder.toString();
    }
