...
import static com.xyp.gtnc.ae2thing.client.render.RenderHelper.updateColorAndDrawItemBorder;
...
import com.xyp.gtnc.ae2thing.network.CPacketRenamer;
...
import com.xyp.gtnc.ae2thing.util.NeCharUtil;
...
public class GuiBaseInterfaceWireless extends BaseMEGui implements IDropToFillTextField, IInterfaceTerminalPostUpdate {
    ...
    private boolean recipeIsBroken(final ItemStack itemStack) {
        ...
        try {
            if (itemStack.getItem() instanceof appeng.api.implementations.ICraftingPatternItem cpi) {
                return cpi.getPatternForItem(itemStack, w) == null;
            }
