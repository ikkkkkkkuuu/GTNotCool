    ...
    public List<String> getMixins(Set<String> loadedMods) {
        ...
        if (loadedMods.contains(MOD_GREGTECH)) {
            addAll(
                ...
                "Gregtech.ForgeOfGodsDataMixin",
                "Gregtech.SteamGodforgeFuelPanelMixin",
                "Gregtech.SteamGodforgeMilestonePanelMixin",
                "Gregtech.SteamGodforgeMilestoneOverviewMixin",
                "Gregtech.SteamGodforgeUpgradePanelMixin",
                "Gregtech.SteamGodforgeTreePanelMixin",
                "Gregtech.SteamGodforgeSmeltingPowerMixin",
                "Gregtech.SteamGodforgeMoltenPowerMixin",
