...
@Mixin(targets = "tectech.thing.metaTileEntity.multi.godforge.MTESmeltingModule$1", remap = false)
public class SteamGodforgeSmeltingPowerMixin {

    @Shadow
    @Final
    private MTESmeltingModule this$0;
