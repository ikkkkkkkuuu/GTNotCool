...
@Mixin(targets = "tectech.thing.metaTileEntity.multi.godforge.MTEPlasmaModule$1", remap = false)
public class SteamGodforgePlasmaPowerMixin {

    @Shadow
    @Final
    private MTEPlasmaModule this$0;
