...
public class RecipeLoader implements Runnable {
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemInputs(
                filterMissingItemInputs(
                    ...
                    ItemList.Casing_StableTitanium.get(64),
                    ItemList.Casing_StableTitanium.get(64),
                    GTOreDictUnificator.get(OrePrefixes.plateDouble, Materials.GlueAdvanced, 8),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            filterMissingItemInputs(
                new ItemStack[] { GTModHandler.getModItem(GTNHIntergalactic.ID, "gt.blockcasingsSE", 64),
                    GTOreDictUnificator.get(OrePrefixes.block, Materials.Titanium, 48),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            filterMissingItemInputs(
                new ItemStack[] { GTModHandler.getModItem(GregTech.ID, "gt.blockmachines", 64, 15465),
                    ...
                    getNewHorizonsCoreItem("LaserEmitter", 1),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            filterMissingItemInputs(
                new Object[] { GTModHandler.getModItem(GregTech.ID, "gt.blockmachines", 64, 1132),
                    ...
                    ItemList.Electric_Pump_UEV.get(16), ItemList.Conveyor_Module_UEV.get(8),
                    ItemList.Robot_Arm_UEV.get(8), new Object[] { OrePrefixes.circuit.get(Materials.UIV), 4 },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            filterMissingItemInputs(
                new ItemStack[] { GTModHandler.getModItem(GregTech.ID, "gt.blockmachines", 64, 357),
                    ...
                    GTModHandler.getModItem(GregTech.ID, "gt.blockmachines", 64, 581),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            filterMissingItemInputs(
                new ItemStack[] { GTModHandler.getModItem(GregTech.ID, "gt.blockmachines", 64, 31151),
                    ...
                    GTModHandler.getModItem(GoodGenerator.ID, "FRF_Coil_3", 64),
                    GTOreDictUnificator.get("lensOrundum", 1),
            ...
            2000,
            (int) TierEU.RECIPE_UXV);
        addAdvancedBoxModuleUpgradeRecipe();
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            new ItemStack(BlockRegister.BoxModule, 1, 13),
            (int) TierEU.UXV,
            32767,
            ...
            filterMissingItemInputs(
                new ItemStack[] { new ItemStack(BlockRegister.BoxRing3, 64), new ItemStack(BlockRegister.BoxRing3, 64),
                    ItemList.Electric_Motor_UXV.get(64), ItemList.Electric_Pump_UXV.get(64),
                    ItemList.Emitter_UXV.get(64), ItemList.Electric_Piston_UXV.get(64), ItemList.Sensor_UXV.get(64),
                    ItemList.Robot_Arm_UXV.get(64), ItemList.GigaChad.get(1),
    ...
    private static void addAdvancedBoxModuleUpgradeRecipe() {
        ItemStack dysonSwarmModule = ItemList.DysonSwarmModule.get(1);
        ItemStack gregTechMachine = GTModHandler.getModItem(GregTech.ID, "gt.blockmachines", 64, 14001);
        ItemStack marsMachine = GTModHandler.getModItem(GalacticraftMars.ID, "tile.marsMachine", 1, 4);
        ItemStack stargateShieldingFoil = getNewHorizonsCoreItem("StargateShieldingFoil", 1);
    ...
    @SafeVarargs
    private static <T> T[] filterMissingItemInputs(T... inputs) {
        int presentInputCount = 0;
        for (T input : inputs) {
            if (input != null) {
                presentInputCount++;
            }
        }
        if (presentInputCount == inputs.length) {
            return inputs;
        }

        T[] filteredInputs = Arrays.copyOf(inputs, presentInputCount);
        int filteredIndex = 0;
        for (T input : inputs) {
            if (input != null) {
        ...
        boxplusplus.LOG.warn(
            "Ignored {} missing item input(s) while registering a Box++ recipe.",
            inputs.length - presentInputCount);
    ...
    private static ItemStack getNewHorizonsCoreItem(String itemName, int amount) {
        ItemStack stack = GTModHandler.getModItem(NewHorizonsCoreMod.ID, itemName, amount);
        if (stack != null) {
            return stack;
        }
        return GTModHandler.getModItem(NewHorizonsCoreMod.ID, "item." + itemName, amount);
    }
    ...
    public static void addModuleResearchRecipe() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemInputs(filterMissingItemInputs(GTModHandler.getModItem(GregTech.ID, "gt.blockmachines", 1, 3004)))
            .eut(TierEU.RECIPE_LuV)
            .duration(1200)
            .addTo(assemblerRecipes);
        // 液位调节器实验模型
        GTValues.RA.stdBuilder()
            ...
            .itemInputs(filterMissingItemInputs(GTModHandler.getModItem(GregTech.ID, "gt.blockmachines", 1, 31077)))
            .eut(TierEU.RECIPE_UV)
            .duration(1200)
            .addTo(assemblerRecipes);
        // 固态物质重塑理论研究
        GTValues.RA.stdBuilder()
            ...
            .itemInputs(filterMissingItemInputs(GTModHandler.getModItem(GregTech.ID, "gt.blockmachines", 1, 992)))
            .eut(TierEU.RECIPE_UV)
            .duration(1200)
            .addTo(assemblerRecipes);
        // 抽水马桶设计图纸（初版）
        GTValues.RA.stdBuilder()
            ...
            .itemInputs(filterMissingItemInputs(GTModHandler.getModItem(GregTech.ID, "gt.blockmachines", 1, 850)))
            .eut(TierEU.RECIPE_UV)
            .duration(1200)
            .addTo(assemblerRecipes);
        // 温差产生原理实验装置
        GTValues.RA.stdBuilder()
            ...
            .itemInputs(filterMissingItemInputs(GTModHandler.getModItem(GregTech.ID, "gt.blockmachines", 1, 12730)))
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemInputs(filterMissingItemInputs(GTModHandler.getModItem(GregTech.ID, "gt.blockmachines", 1, 17001)))
            .eut(TierEU.RECIPE_UEV)
            .duration(1200)
            .addTo(assemblerRecipes);
        // 物态并联原理研究笔记
        GTValues.RA.stdBuilder()
            ...
            .itemInputs(filterMissingItemInputs(GTModHandler.getModItem(GregTech.ID, "gt.blockmachines", 1, 31150)))
            .eut(TierEU.RECIPE_UEV)
            .duration(1200)
            .addTo(assemblerRecipes);
        // 聚焦技术实验报告
        GTValues.RA.stdBuilder()
            ...
            .itemInputs(filterMissingItemInputs(GTModHandler.getModItem(GregTech.ID, "gt.blockmachines", 1, 15472)))
            .eut(TierEU.RECIPE_UEV)
            .duration(1200)
            .addTo(assemblerRecipes);
        // 深蓝物质研究样本
